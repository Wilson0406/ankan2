...
function SectionrightCard(props) {
    ...
    return (
        <div className="pov-card" style={{minHeight:"21rem", marginTop:"-30rem", paddingTop:"1rem", marginLeft:"49rem", marginBottom:"4rem", position:"relative"}}>
           ...
           { props.data?(
            <div className="row">
                ...
                <div className="pov-card-right-col-md-12">
                    <div className='top-card' style={{ width: "18rem",marginLeft:"11px" }}>
